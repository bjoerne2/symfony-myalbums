...
namespace Bjoerne\MyAlbumsBundle\Controller;
...
use Bjoerne\MyAlbumsBundle\Entity\Album;
use Bjoerne\MyAlbumsBundle\Form\AlbumType;
...
class AlbumController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BjoerneMyAlbumsBundle:Album')->findAll();
     ...
     * @Method("POST")
     * @Template("BjoerneMyAlbumsBundle:Album:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BjoerneMyAlbumsBundle:Album')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BjoerneMyAlbumsBundle:Album:edit.html.twig")
     */
